// URLs das planilhas
const PLANILHA_ESTABELECIMENTO = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vQZmNmBIhbdczV0UVK2B8acYNbQiK0sRvtpb-BUWFxs11UD8Cf7ByevZtJNUqe-97w6assKAoVWa0ez/pub?gid=0&single=true&output=csv';
const PLANILHA_CATEGORIAS = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vQZmNmBIhbdczV0UVK2B8acYNbQiK0sRvtpb-BUWFxs11UD8Cf7ByevZtJNUqe-97w6assKAoVWa0ez/pub?gid=1857202639&single=true&output=csv';
const PLANILHA_ITENS = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vQZmNmBIhbdczV0UVK2B8acYNbQiK0sRvtpb-BUWFxs11UD8Cf7ByevZtJNUqe-97w6assKAoVWa0ez/pub?gid=1795510077&single=true&output=csv';
...
function desabilitarBotoesAdicionar() {
    ...
    botoes.forEach(botao => {
        if (!botao.disabled) {
            botao.disabled = true;
            botao.classList.remove('bg-yellow-500', 'hover:bg-green-600');
...
function habilitarBotoesAdicionar() {
    ...
    botoes.forEach(botao => {
        ...
        if (item && (item.disponivel === 'TRUE' || item.disponivel === true || item.disponivel === 'true')) {
            ...
            botao.classList.add('bg-yellow-500', 'text-white', 'hover:bg-green-600');
